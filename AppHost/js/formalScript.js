...
function subMenuTogglerPerElement(element) {
    addEvent([element], 'click', subMenuTogglerClicked);
}
...
function adjustParentContainerWidth(sideBar){
	...
	if(sideBar.style.display === 'none' || screen.width <= 900){
		parentContainer.style.width = '100%';
	}
	else{
		parentContainer.style.width = 'calc(100% - 300px)';
	}
}
